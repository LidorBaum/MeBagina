    ...
    const loginForm = (
        <View>
            <View
                ...
                collum style={{ width: 250, height: 400, justifyContent: 'space-between', alignContent: 'space-between' }}>
                ...
                <TextField
                    ...
                    style={{ textAlign: 'left', borderBottomWidth: 2, borderBottomColor: loginCred.email ? Colors.moonOrSun : Colors.violet20 }}
                />
                <TextField
                    text70
                    color={Colors.moonOrSun}
                    ...
                    style={{ textAlign: 'left', borderBottomWidth: 2, borderBottomColor: loginCred.password ? Colors.moonOrSun : Colors.violet20 }}

                // floatOnFocus
                />
                <Button style={{ marginBottom: 20 }} label="התחבר" onPress={signIn} />
                <Button style={{ marginBottom: 20 }} label="התחבר הארד קוד" onPress={signInHardCode} />
                ...
                <Button
                style={{marginTop: 20}}
                label="חדש כאן? צור משתמש" onPress={() => setIsNewUser(true)} />
            </View>
        </View>
    )
        ...
        <View>
            <View
                ...
                <TextField
                    ...
                    floatingPlaceholderStyle={{ color: Colors.blue70 }}
                    placeholderTextColor={Colors.transparent}
                    style={{ textAlign: 'left', borderBottomWidth: 2, borderBottomColor: signupCred.name ? Colors.moonOrSun : Colors.violet20 }}
                />
                <TextField
                    text70
                    color={Colors.moonOrSun}
                    ...
                    floatingPlaceholderStyle={{ color: Colors.blue70 }}
                    placeholderTextColor={Colors.transparent}
                    style={{ textAlign: 'left', borderBottomWidth: 2, borderBottomColor: signupCred.email ? Colors.moonOrSun : Colors.violet20 }}
                />
                <TextField
                    text70
                    color={Colors.moonOrSun}
                    ...
                    floatingPlaceholderStyle={{ color: Colors.blue70 }}
                    placeholderTextColor={Colors.transparent}
                    style={{ textAlign: 'left', borderBottomWidth: 2, borderBottomColor: signupCred.password ? Colors.moonOrSun : Colors.violet20 }}
                />
                <Button
                style={{ marginBottom: 20 }}
                label="הירשם" onPress={createUser} />
                ...
                <Button 
                style={{marginTop: 20,}}
                label="נרשמת כבר? התחבר" onPress={() => setIsNewUser(false)} />
            </View>
        </View>
    )

    return (
        <View style={{ marginTop:100, alignItems: 'center', justifyContent: 'center',  height: '50%'}}>
            {/* <View style={{}}> */}
                <Image
