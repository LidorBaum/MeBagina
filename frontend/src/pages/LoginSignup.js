...
export const LoginSignup = (props) => {
  ...
  const checkCompanyNameAvailability = async (
    ...
    const isNameAvailable = await companyService.checkCompanyNameAvailability(
      companyName
    );
    if (isNameAvailable) {
        ...
        <div className="form-container sign-up-container">
          <form action="#" onSubmit={doSignup}>
            ...
            <div className="input-name-div">
              ...
              />
              {!isAvailable && signupCred.companyName.length > 2 && (
                <img
        ...
        <div className="overlay-container">
          <div className="overlay">
            ...
            <div className="overlay-panel overlay-right">
              ...
              <button ref={signupButton} className="ghost" id="signUp">
                Sign Up
              </button>
            </div>
          </div>
